...
![Tests](https://img.shields.io/badge/tests-2718-brightgreen)
...
# Run on-chain tests (572 LiteSVM tests — no validator needed)
...
| Security exploit scenarios                                                                               | 185      |
...
| Kit-native SDK (`@usesigil/kit` — includes merged core + dashboard)                                      | 1829     |
