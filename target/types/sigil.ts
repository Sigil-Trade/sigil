...
export type Sigil = {
  ...
  instructions: [
    ...
    },
    {
      ...
      docs: ["Apply a queued agent permissions update after timelock expires."];
      discriminator: [234, 166, 205, 3, 28, 166, 221, 240];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [133, 184, 235, 88, 53, 237, 43, 145];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          relations: ["policy", "constraints", "pendingConstraints"];
        },
        {
          name: "policy";
          docs: [
    ...
    },
    {
      ...
      docs: ["Cancel a queued agent permissions update."];
      discriminator: [92, 232, 92, 115, 110, 238, 235, 55];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    },
    {
      ...
      docs: ["Cancel a queued constraint closure."];
      discriminator: [150, 125, 186, 114, 40, 105, 237, 184];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [182, 37, 105, 181, 28, 195, 223, 167];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    },
    {
      ...
      docs: ["Queue a constraint closure. Timelock-gated."];
      discriminator: [248, 124, 93, 115, 195, 88, 11, 109];
      accounts: [
        {
          name: "owner";
          writable: true;
  ...
  accounts: [
    ...
    },
    {
      ...
      discriminator: [137, 132, 60, 184, 171, 184, 194, 56];
    },
    {
      name: "pendingCloseConstraints";
      discriminator: [128, 154, 58, 181, 85, 163, 243, 233];
    },
    {
  ...
  events: [
    ...
    },
    {
      ...
      discriminator: [233, 247, 103, 30, 130, 173, 196, 183];
    },
    {
      name: "agentPermissionsChangeCancelled";
      discriminator: [107, 21, 129, 77, 1, 136, 68, 216];
    },
    {
      name: "agentPermissionsChangeQueued";
      discriminator: [211, 242, 237, 217, 72, 52, 150, 80];
    },
    {
    ...
    },
    {
      ...
      discriminator: [186, 62, 25, 109, 144, 207, 83, 13];
    },
    {
      name: "closeConstraintsCancelled";
      discriminator: [102, 226, 171, 191, 99, 98, 255, 134];
    },
    {
      name: "closeConstraintsQueued";
      discriminator: [77, 23, 232, 153, 108, 46, 243, 53];
    },
    {
