...
const SOURCE_ATA =
  "SourceATACCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC" as Address;
const DEST_ATA =
  "DestATADDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD" as Address;
const MINT_ADDRESS =
  "MintEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE" as Address;
const FAKE_PROGRAM =
  "FakeProgramFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" as Address;
