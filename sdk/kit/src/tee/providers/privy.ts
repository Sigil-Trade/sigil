/**
 * Privy TEE Attestation Provider — AWS Nitro Enclaves.
 *
...
export const verifyPrivy = createManagedVerifier({
  provider: "privy",
  enclaveType: "nitro",
  infrastructureDescription: "AWS Nitro Enclave infrastructure",
});
