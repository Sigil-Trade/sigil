...
export type SetTestTimeAsyncInput<
...
export async function getSetTestTimeInstructionAsync<
  TAccountAdmin extends string,
  TAccountMultisig extends string,
  TAccountPerpetuals extends string,
...
export function getSetTestTimeInstruction<
  ...
  TProgramAddress extends Address = typeof PERPETUALS_PROGRAM_ADDRESS,
>(
  input: SetTestTimeInput<TAccountAdmin, TAccountMultisig, TAccountPerpetuals>,
  config?: { programAddress?: TProgramAddress },
): SetTestTimeInstruction<
  TProgramAddress,
  TAccountAdmin,
