...
export const INIT_OBLIGATION_FARMS_FOR_RESERVE_DISCRIMINATOR = new Uint8Array([
  136, 63, 15, 186, 211, 152, 168, 164,
]);

export function getInitObligationFarmsForReserveDiscriminatorBytes() {
...
> {
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta("obligationFarm", accounts.obligationFarm),
