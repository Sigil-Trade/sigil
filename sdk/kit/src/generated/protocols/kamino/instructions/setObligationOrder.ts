...
export const SET_OBLIGATION_ORDER_DISCRIMINATOR = new Uint8Array([
  81, 1, 99, 156, 211, 83, 78, 46,
]);

export function getSetObligationOrderDiscriminatorBytes() {
...
export function getSetObligationOrderInstructionDataEncoder(): FixedSizeEncoder<SetObligationOrderInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["index", getU8Encoder()],
      ["order", getObligationOrderEncoder()],
    ]),
    (value) => ({
      ...value,
...
export function getSetObligationOrderInstructionDataDecoder(): FixedSizeDecoder<SetObligationOrderInstructionData> {
  return getStructDecoder([
    ...
    ["index", getU8Decoder()],
    ["order", getObligationOrderDecoder()],
  ]);
}
