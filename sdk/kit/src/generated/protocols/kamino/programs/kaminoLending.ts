...
import {
  ...
  type BorrowObligationLiquidityInput,
  type BorrowObligationLiquidityV2Input,
  type DeleteReferrerStateAndShortUrlInput,
  type DepositAndWithdrawInput,
  type DepositObligationCollateralInput,
  type DepositObligationCollateralV2Input,
  type DepositReserveLiquidityAndObligationCollateralInput,
  type DepositReserveLiquidityAndObligationCollateralV2Input,
  type DepositReserveLiquidityInput,
  type FlashBorrowReserveLiquidityInput,
  type FlashRepayReserveLiquidityInput,
  type IdlMissingTypesInput,
  type InitFarmsForReserveInput,
  type InitGlobalConfigInput,
  type InitLendingMarketInput,
  type InitObligationFarmsForReserveInput,
  ...
  type LiquidateObligationAndRedeemReserveCollateralInput,
  ...
  type RedeemFeesInput,
  type RedeemReserveCollateralInput,
  type RefreshObligationFarmsForReserveInput,
  ...
  type WithdrawObligationCollateralAndRedeemReserveCollateralInput,
  type WithdrawObligationCollateralAndRedeemReserveCollateralV2Input,
  type WithdrawObligationCollateralInput,
  type WithdrawObligationCollateralV2Input,
  type WithdrawProtocolFeeInput,
  type WithdrawReferrerFeesInput,
} from "../instructions";

export const KAMINO_LENDING_PROGRAM_ADDRESS = "" as Address<"">;
...
export function identifyKaminoLendingAccount(
  ...
  if (
    ...
    return KaminoLendingAccount.GlobalConfig;
  }
  if (
    containsBytes(
      data,
...
export type ParsedKaminoLendingInstruction<TProgram extends string = ""> =
  | ({
...
export type KaminoLendingPluginInstructions = {
  ...
  ) => ReturnType<typeof getInitLendingMarketInstruction> &
  ...
  ) => ReturnType<typeof getInitReserveInstruction> & SelfPlanAndSendFunctions;
  initFarmsForReserve: (
    input: InitFarmsForReserveInput,
  ) => ReturnType<typeof getInitFarmsForReserveInstruction> &
    SelfPlanAndSendFunctions;
  updateReserveConfig: (
  ...
  ) => ReturnType<typeof getRedeemFeesInstruction> & SelfPlanAndSendFunctions;
  withdrawProtocolFee: (
    input: WithdrawProtocolFeeInput,
  ) => ReturnType<typeof getWithdrawProtocolFeeInstruction> &
    SelfPlanAndSendFunctions;
  socializeLoss: (
  ...
  ) => ReturnType<typeof getSocializeLossV2Instruction> &
    SelfPlanAndSendFunctions;
  markObligationForDeleveraging: (
  ...
  ) => ReturnType<typeof getDepositReserveLiquidityInstruction> &
    SelfPlanAndSendFunctions;
  redeemReserveCollateral: (
    input: RedeemReserveCollateralInput,
  ) => ReturnType<typeof getRedeemReserveCollateralInstruction> &
    SelfPlanAndSendFunctions;
  initObligation: (
    ...
    SelfPlanAndSendFunctions;
  initObligationFarmsForReserve: (
    input: MakeOptional<InitObligationFarmsForReserveInput, "payer">,
  ) => ReturnType<typeof getInitObligationFarmsForReserveInstruction> &
    SelfPlanAndSendFunctions;
  refreshObligationFarmsForReserve: (
    input: RefreshObligationFarmsForReserveInput,
  ) => ReturnType<typeof getRefreshObligationFarmsForReserveInstruction> &
    SelfPlanAndSendFunctions;
  refreshObligation: (
  ...
  ) => ReturnType<typeof getDepositObligationCollateralV2Instruction> &
    SelfPlanAndSendFunctions;
  withdrawObligationCollateral: (
    input: WithdrawObligationCollateralInput,
  ) => ReturnType<typeof getWithdrawObligationCollateralInstruction> &
    SelfPlanAndSendFunctions;
  withdrawObligationCollateralV2: (
    input: WithdrawObligationCollateralV2Input,
  ) => ReturnType<typeof getWithdrawObligationCollateralV2Instruction> &
    SelfPlanAndSendFunctions;
  borrowObligationLiquidity: (
    input: BorrowObligationLiquidityInput,
  ) => ReturnType<typeof getBorrowObligationLiquidityInstruction> &
    SelfPlanAndSendFunctions;
  borrowObligationLiquidityV2: (
    input: BorrowObligationLiquidityV2Input,
  ) => ReturnType<typeof getBorrowObligationLiquidityV2Instruction> &
    SelfPlanAndSendFunctions;
  repayObligationLiquidity: (
  ...
  ) => ReturnType<typeof getRepayObligationLiquidityV2Instruction> &
    SelfPlanAndSendFunctions;
  repayAndWithdrawAndRedeem: (
  ...
  depositReserveLiquidityAndObligationCollateral: (
    ...
    typeof getDepositReserveLiquidityAndObligationCollateralInstruction
  > &
    SelfPlanAndSendFunctions;
  depositReserveLiquidityAndObligationCollateralV2: (
    input: DepositReserveLiquidityAndObligationCollateralV2Input,
  ) => ReturnType<
    typeof getDepositReserveLiquidityAndObligationCollateralV2Instruction
  > &
    SelfPlanAndSendFunctions;
  withdrawObligationCollateralAndRedeemReserveCollateral: (
    input: WithdrawObligationCollateralAndRedeemReserveCollateralInput,
  ) => ReturnType<
    typeof getWithdrawObligationCollateralAndRedeemReserveCollateralInstruction
  > &
    SelfPlanAndSendFunctions;
  withdrawObligationCollateralAndRedeemReserveCollateralV2: (
    input: WithdrawObligationCollateralAndRedeemReserveCollateralV2Input,
  ) => ReturnType<
    typeof getWithdrawObligationCollateralAndRedeemReserveCollateralV2Instruction
  > &
    SelfPlanAndSendFunctions;
  liquidateObligationAndRedeemReserveCollateral: (
    input: LiquidateObligationAndRedeemReserveCollateralInput,
  ) => ReturnType<
    typeof getLiquidateObligationAndRedeemReserveCollateralInstruction
  > &
    SelfPlanAndSendFunctions;
  liquidateObligationAndRedeemReserveCollateralV2: (
  ...
  ) => ReturnType<typeof getFlashRepayReserveLiquidityInstruction> &
    SelfPlanAndSendFunctions;
  flashBorrowReserveLiquidity: (
    input: FlashBorrowReserveLiquidityInput,
  ) => ReturnType<typeof getFlashBorrowReserveLiquidityInstruction> &
    SelfPlanAndSendFunctions;
  requestElevationGroup: (
  ...
  ) => ReturnType<typeof getWithdrawReferrerFeesInstruction> &
    SelfPlanAndSendFunctions;
  initReferrerStateAndShortUrl: (
  ...
  setObligationOrder: (
    ...
    SelfPlanAndSendFunctions;
  initGlobalConfig: (
    input: MakeOptional<InitGlobalConfigInput, "payer">,
  ) => ReturnType<typeof getInitGlobalConfigInstruction> &
    SelfPlanAndSendFunctions;
  updateGlobalConfig: (
...
export function kaminoLendingProgram() {
  return <T extends KaminoLendingPluginRequirements>(client: T) => {
    return {
      ...client,
      kaminoLending: <KaminoLendingPlugin>{
        ...
        instructions: {
          initLendingMarket: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getInitLendingMarketInstruction(input),
            ),
          ...
          initReserve: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getInitReserveInstruction(input),
            ),
          initFarmsForReserve: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getInitFarmsForReserveInstruction(input),
            ),
          ...
          redeemFees: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getRedeemFeesInstruction(input),
            ),
          withdrawProtocolFee: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getWithdrawProtocolFeeInstruction(input),
            ),
          socializeLoss: (input) =>
            addSelfPlanAndSendFunctions(
              client,
          ...
          socializeLossV2: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getSocializeLossV2Instruction(input),
            ),
          ...
          depositReserveLiquidity: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getDepositReserveLiquidityInstruction(input),
            ),
          redeemReserveCollateral: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getRedeemReserveCollateralInstruction(input),
            ),
          ...
          refreshObligationFarmsForReserve: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getRefreshObligationFarmsForReserveInstruction(input),
            ),
          ...
          depositObligationCollateralV2: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getDepositObligationCollateralV2Instruction(input),
            ),
          withdrawObligationCollateral: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getWithdrawObligationCollateralInstruction(input),
            ),
          withdrawObligationCollateralV2: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getWithdrawObligationCollateralV2Instruction(input),
            ),
          borrowObligationLiquidity: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getBorrowObligationLiquidityInstruction(input),
            ),
          borrowObligationLiquidityV2: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getBorrowObligationLiquidityV2Instruction(input),
            ),
          ...
          repayObligationLiquidityV2: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getRepayObligationLiquidityV2Instruction(input),
            ),
          ...
          flashRepayReserveLiquidity: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getFlashRepayReserveLiquidityInstruction(input),
            ),
          flashBorrowReserveLiquidity: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getFlashBorrowReserveLiquidityInstruction(input),
            ),
          ...
          withdrawReferrerFees: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getWithdrawReferrerFeesInstruction(input),
            ),
