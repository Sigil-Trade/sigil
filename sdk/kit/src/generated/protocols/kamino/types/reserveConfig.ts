...
export function getReserveConfigEncoder(): FixedSizeEncoder<ReserveConfigArgs> {
  return getStructEncoder([
    ...
    ["reserved2", fixEncoderSize(getBytesEncoder(), 9)],
    ...
    ["reserved1", fixEncoderSize(getBytesEncoder(), 1)],
...
export function getReserveConfigDecoder(): FixedSizeDecoder<ReserveConfig> {
  return getStructDecoder([
    ...
    ["reserved2", fixDecoderSize(getBytesDecoder(), 9)],
    ...
    ["reserved1", fixDecoderSize(getBytesDecoder(), 1)],
