...
if (process.env.NODE_ENV !== "production") {
  kaminoLendingErrorMessages = {
    [KAMINO_LENDING_ERROR__BORROWING_ABOVE_UTILIZATION_RATE_DISABLED]: `Borrowing above set utilization rate is disabled`,
    [KAMINO_LENDING_ERROR__BORROWING_DISABLED]: `Borrowing is disabled`,
    [KAMINO_LENDING_ERROR__BORROWING_DISABLED_OUTSIDE_ELEVATION_GROUP]: `Reserve does not accept any new borrows outside elevation group`,
    [KAMINO_LENDING_ERROR__BORROW_LIMIT_EXCEEDED]: `Cannot borrow above borrow limit`,
    [KAMINO_LENDING_ERROR__BORROW_TOO_LARGE]: `Borrow amount too large for deposited collateral`,
    [KAMINO_LENDING_ERROR__BORROW_TOO_SMALL]: `Borrow amount too small to receive liquidity after fees`,
    [KAMINO_LENDING_ERROR__CANNOT_CALCULATE_REFERRAL_AMOUNT_DUE_TO_SLOTS_MISMATCH]: `Cannot calculate referral amount due to slots mismatch`,
    ...
    [KAMINO_LENDING_ERROR__COLLATERAL_NON_LIQUIDATABLE]: `This collateral cannot be liquidated (LTV set to 0)`,
    [KAMINO_LENDING_ERROR__COULD_NOT_DESERIALIZE_SCOPE]: `Cannot deserialize the scope price account`,
    ...
    [KAMINO_LENDING_ERROR__DEPOSIT_LIMIT_EXCEEDED]: `Cannot deposit above deposit limit`,
    [KAMINO_LENDING_ERROR__DEPRECATED_INVALID_OBLIGATION_ID]: `[DEPRECATED] Obligation id must be 0`,
    [KAMINO_LENDING_ERROR__ELEVATION_GROUP_ALREADY_ACTIVATED]: `Obligation already part of the same elevation group`,
    [KAMINO_LENDING_ERROR__ELEVATION_GROUP_BORROW_LIMIT_EXCEEDED]: `Elevation group borrow limit exceeded`,
    ...
    [KAMINO_LENDING_ERROR__ELEVATION_GROUP_HAS_ANOTHER_DEBT_RESERVE]: `In elevation group attempt to borrow from a reserve that is not the debt reserve`,
    [KAMINO_LENDING_ERROR__ELEVATION_GROUP_MAX_COLLATERAL_RESERVE_ZERO]: `The elevation group does not allow any collateral reserves`,
    [KAMINO_LENDING_ERROR__ELEVATION_GROUP_NEW_LOANS_DISABLED]: `Elevation group does not accept any new loans or any new borrows/withdrawals`,
    [KAMINO_LENDING_ERROR__ELEVATION_GROUP_WITHOUT_DEBT_RESERVE]: `The elevation group does not have a debt reserve defined`,
    [KAMINO_LENDING_ERROR__FARM_ACCOUNTS_MISSING]: `Farm accounts to refresh are missing`,
    [KAMINO_LENDING_ERROR__FLASH_BORROW_CPI]: `No cpi flash borrows allowed`,
    [KAMINO_LENDING_ERROR__FLASH_LOANS_DISABLED]: `Flash loans are disabled for this reserve`,
    ...
    [KAMINO_LENDING_ERROR__INCORRECT_INSTRUCTION_IN_POSITION]: `Wrong instruction at expected position`,
    [KAMINO_LENDING_ERROR__INSUFFICIENT_LIQUIDITY]: `Insufficient liquidity available`,
    [KAMINO_LENDING_ERROR__INSUFFICIENT_PROTOCOL_FEES_TO_REDEEM]: `Insufficient protocol fees to claim or no liquidity available`,
    [KAMINO_LENDING_ERROR__INSUFFICIENT_REFERRAL_FEES_TO_REDEEM]: `Insufficient referral fees to claim or no liquidity available`,
    [KAMINO_LENDING_ERROR__INSUFFICIENT_REPAY_AMOUNT]: `Liquidator provided repay amount lower than required by liquidation rules`,
    [KAMINO_LENDING_ERROR__INTEGER_OVERFLOW]: `Conversion between integers failed`,
    [KAMINO_LENDING_ERROR__INVALID_ACCOUNT_INPUT]: `Invalid account input`,
    [KAMINO_LENDING_ERROR__INVALID_ACCOUNT_OWNER]: `Input account owner is not the program address`,
    [KAMINO_LENDING_ERROR__INVALID_AMOUNT]: `Input amount is invalid`,
    [KAMINO_LENDING_ERROR__INVALID_BORROW_RATE_CURVE_POINT]: `Invalid borrow rate curve point`,
    [KAMINO_LENDING_ERROR__INVALID_CONFIG]: `Input config value is invalid`,
    [KAMINO_LENDING_ERROR__INVALID_ELEVATION_GROUP]: `The elevation group chosen for the reserve does not exist in the lending market`,
    [KAMINO_LENDING_ERROR__INVALID_ELEVATION_GROUP_CONFIG]: `The elevation group updated has wrong parameters set`,
    ...
    [KAMINO_LENDING_ERROR__INVALID_MARKET_AUTHORITY]: `Market authority is invalid`,
    [KAMINO_LENDING_ERROR__INVALID_MARKET_OWNER]: `Market owner is invalid`,
    [KAMINO_LENDING_ERROR__INVALID_OBLIGATION_COLLATERAL]: `Invalid obligation collateral`,
    [KAMINO_LENDING_ERROR__INVALID_OBLIGATION_LIQUIDITY]: `Invalid obligation liquidity`,
    [KAMINO_LENDING_ERROR__INVALID_OBLIGATION_OWNER]: `Obligation owner is invalid`,
    [KAMINO_LENDING_ERROR__INVALID_OBLIGATION_SEEDS_VALUE]: `Seeds must be default pubkeys for tag 0, and mint addresses for tag 1 or 2`,
    [KAMINO_LENDING_ERROR__INVALID_ORACLE_CONFIG]: `Input oracle config is invalid`,
    [KAMINO_LENDING_ERROR__INVALID_ORDER_CONFIGURATION]: `Given order configuration has wrong parameters`,
    [KAMINO_LENDING_ERROR__INVALID_PYTH_PRICE_ACCOUNT]: `Pyth price account does not match configuration`,
    [KAMINO_LENDING_ERROR__INVALID_SCOPE_PRICE_ACCOUNT]: `Scope price account does not match configuration`,
    [KAMINO_LENDING_ERROR__INVALID_SIGNER]: `Input account must be a signer`,
    [KAMINO_LENDING_ERROR__INVALID_SWITCHBOARD_ACCOUNT]: `Switchboard account(s) do not match configuration`,
    ...
    [KAMINO_LENDING_ERROR__INVALID_UTILIZATION_RATE]: `Invalid utilization rate`,
    [KAMINO_LENDING_ERROR__ISOLATED_ASSET_TIER_VIOLATION]: `Isolated Asset Tier Violation`,
    [KAMINO_LENDING_ERROR__LAST_TIMESTAMP_GREATER_THAN_CURRENT]: `The last interval start timestamp is greater than the current timestamp`,
    [KAMINO_LENDING_ERROR__LENDING_MARKETS_MUST_MATCH]: `Lending markets must match`,
    [KAMINO_LENDING_ERROR__LIABILITIES_BIGGER_THAN_ASSETS]: `Cannot have more liabilities than assets in a position`,
    [KAMINO_LENDING_ERROR__LIQUIDATION_BORROW_FACTOR_PRIORITY]: `Liquidation must prioritize the debt with the highest borrow factor`,
    [KAMINO_LENDING_ERROR__LIQUIDATION_LOWEST_LIQUIDATION_LTV_PRIORITY]: `Liquidation must prioritize the collateral with the lowest liquidation LTV`,
    [KAMINO_LENDING_ERROR__LIQUIDATION_REWARD_TOO_SMALL]: `The reward amount is less than the minimum acceptable received liquidity`,
    [KAMINO_LENDING_ERROR__LIQUIDATION_TOO_SMALL]: `Liquidation amount too small to receive collateral`,
    [KAMINO_LENDING_ERROR__LOWEST_LTV_ASSETS_PRIORITY]: `Withdrawing must prioritize the collateral with the lowest reserve max-LTV`,
    [KAMINO_LENDING_ERROR__MATH_OVERFLOW]: `Math operation overflow`,
    [KAMINO_LENDING_ERROR__MAXIMUM_WITHDRAW_VALUE_ZERO]: `Maximum withdrawable value of this collateral is zero, LTV needs improved`,
    [KAMINO_LENDING_ERROR__MULTIPLE_FLASH_BORROWS]: `Multiple flash borrows not allowed in the same transaction`,
    [KAMINO_LENDING_ERROR__NEGATIVE_INTEREST_RATE]: `Interest rate is negative`,
    [KAMINO_LENDING_ERROR__NET_VALUE_REMAINING_TOO_SMALL]: `Net value remaining too small`,
    [KAMINO_LENDING_ERROR__NO_FARM_FOR_RESERVE]: `This reserve does not have a farm`,
    [KAMINO_LENDING_ERROR__NO_FLASH_REPAY_FOUND]: `No corresponding repay found for flash borrow`,
    [KAMINO_LENDING_ERROR__NO_PRICE_FOUND]: `No price found`,
    [KAMINO_LENDING_ERROR__NO_UPGRADE_AUTHORITY]: `Cannot initialize global config because there is no upgrade authority to the program`,
    [KAMINO_LENDING_ERROR__OBLIGATION_BORROWS_EMPTY]: `Obligation borrows are empty`,
    [KAMINO_LENDING_ERROR__OBLIGATION_BORROWS_ZERO]: `Obligation borrows have zero value`,
    [KAMINO_LENDING_ERROR__OBLIGATION_COLLATERAL_EMPTY]: `Obligation collateral is empty`,
    [KAMINO_LENDING_ERROR__OBLIGATION_COLLATERAL_EXCEEDS_ELEVATION_GROUP_LIMIT]: `Obligation have more collateral than the maximum allowed by the elevation group`,
    [KAMINO_LENDING_ERROR__OBLIGATION_COLLATERAL_LTV_ZERO]: `The obligation has one collateral with an LTV set to 0. Withdraw it before withdrawing other collaterals`,
    [KAMINO_LENDING_ERROR__OBLIGATION_CURRENTLY_MARKED_FOR_DELEVERAGING]: `Obligation is already marked for deleveraging`,
    [KAMINO_LENDING_ERROR__OBLIGATION_DEPOSITS_EMPTY]: `Obligation deposits are empty`,
    [KAMINO_LENDING_ERROR__OBLIGATION_DEPOSITS_ZERO]: `Obligation deposits have zero value`,
    [KAMINO_LENDING_ERROR__OBLIGATION_ELEVATION_GROUP_MULTIPLE_DEBT_RESERVE]: `Obligation is an elevation group but have more than one debt reserve`,
    [KAMINO_LENDING_ERROR__OBLIGATION_EMPTY]: `Obligation has no borrows or deposits.`,
    [KAMINO_LENDING_ERROR__OBLIGATION_HEALTHY]: `Cannot liquidate healthy obligations`,
    [KAMINO_LENDING_ERROR__OBLIGATION_IN_OBSOLETE_RESERVE]: `Obligation has a deposit or borrow in an obsolete reserve`,
    [KAMINO_LENDING_ERROR__OBLIGATION_LIQUIDITY_EMPTY]: `Obligation liquidity is empty`,
    [KAMINO_LENDING_ERROR__OBLIGATION_OWNERS_MUST_MATCH]: `Obligation owners must match`,
    [KAMINO_LENDING_ERROR__OBLIGATION_RESERVE_LIMIT]: `Obligation reserve limit exceeded`,
    [KAMINO_LENDING_ERROR__OBLIGATIONS_MUST_MATCH]: `Obligations must match`,
    [KAMINO_LENDING_ERROR__OBLIGATION_STALE]: `Obligation state needs to be refreshed`,
    [KAMINO_LENDING_ERROR__OPERATION_NOT_PERMITTED_MARKET_IMMUTABLE]: `Cannot update lending market because it is set as immutable`,
    [KAMINO_LENDING_ERROR__OPERATION_NOT_PERMITTED_WITH_CURRENT_OBLIGATION_ORDERS]: `Single debt, single collateral obligation orders have to be cancelled before changing the deposit/borrow count`,
    [KAMINO_LENDING_ERROR__ORDER_CONFIGURATION_NOT_SUPPORTED_BY_OBLIGATION]: `Given order configuration cannot be used with the current state of the obligation`,
    [KAMINO_LENDING_ERROR__ORDER_CREATION_DISABLED]: `Creation of new orders is disabled`,
    [KAMINO_LENDING_ERROR__ORDER_INDEX_OUT_OF_BOUNDS]: `Obligation order of the given index cannot exist`,
    [KAMINO_LENDING_ERROR__PRICE_CONFIDENCE_TOO_WIDE]: `Price confidence too wide`,
    [KAMINO_LENDING_ERROR__PRICE_IS_BIGGER_THAN_HEURISTIC]: `Price is bigger than allowed by heuristic`,
    [KAMINO_LENDING_ERROR__PRICE_IS_LOWER_THAN_HEURISTIC]: `Price lower than allowed by heuristic`,
    [KAMINO_LENDING_ERROR__PRICE_IS_ZERO]: `Price is zero`,
    [KAMINO_LENDING_ERROR__PRICE_NOT_VALID]: `Price is not valid`,
    [KAMINO_LENDING_ERROR__PRICE_TOO_DIVERGENT_FROM_TWAP]: `Price too divergent from twap`,
    [KAMINO_LENDING_ERROR__PRICE_TOO_OLD]: `Price too old`,
    [KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_MINT_MISSMATCH]: `Referrer account mint does not match the operation reserve mint`,
    [KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_MISSING]: `Referrer account missing for obligation with referrer`,
    [KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_NOT_INITIALIZED]: `Referrer account not initialized`,
    [KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_REFERRER_MISSMATCH]: `Referrer account referrer does not match the owner referrer`,
    [KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_WRONG_ADDRESS]: `Referrer account address is not a valid program address`,
    [KAMINO_LENDING_ERROR__REFERRER_STATE_OWNER_MISMATCH]: `Referrer state owner does not match the given signer`,
    [KAMINO_LENDING_ERROR__REPAY_TOO_SMALL]: `Repay amount too small to transfer liquidity`,
    [KAMINO_LENDING_ERROR__REPAY_TOO_SMALL_FOR_FULL_LIQUIDATION]: `Repay amount is too small to satisfy the mandatory full liquidation`,
    [KAMINO_LENDING_ERROR__RESERVE_ACCOUNTING_MISMATCH]: `Reserve internal state accounting has been unexpectedly modified`,
    [KAMINO_LENDING_ERROR__RESERVE_DEPRECATED]: `Reserve was deprecated, no longer usable`,
    [KAMINO_LENDING_ERROR__RESERVE_OBSOLETE]: `Reserve is marked as obsolete`,
    [KAMINO_LENDING_ERROR__RESERVE_STALE]: `Reserve state needs to be refreshed`,
    [KAMINO_LENDING_ERROR__RESERVE_TOKEN_BALANCE_MISMATCH]: `Reserve state and token account cannot drift`,
    [KAMINO_LENDING_ERROR__RESERVE_VAULT_BALANCE_MISMATCH]: `Reserve token account has been unexpectedly modified`,
    [KAMINO_LENDING_ERROR__SHORT_URL_NOT_ASCII_ALPHANUMERIC]: `Referrer short_url is not ascii alphanumeric`,
    [KAMINO_LENDING_ERROR__SWITCHBOARD_V2_ERROR]: `Switchboard error`,
    [KAMINO_LENDING_ERROR__UNHEALTHY_ELEVATION_GROUP_LTV]: `The current obligation must have most or all its debt repaid before changing the elevation group`,
    [KAMINO_LENDING_ERROR__UNSUPPORTED_TOKEN_EXTENSION]: `Mint has a token (2022) extension that is not supported`,
    [KAMINO_LENDING_ERROR__USER_METADATA_OWNER_ALREADY_SET]: `User metadata owner is already set`,
    ...
    [KAMINO_LENDING_ERROR__WORSE_LTV_BLOCKED]: `Cannot get the obligation in a worse position`,
    [KAMINO_LENDING_ERROR__WORSE_LTV_THAN_UNHEALTHY_LTV]: `Cannot get the obligation liquidatable`,
    [KAMINO_LENDING_ERROR__ZERO_MAX_LTV_ASSETS_IN_DEPOSITS]: `No max LTV 0 assets allowed in deposits for repay and withdraw`,
  };
}
