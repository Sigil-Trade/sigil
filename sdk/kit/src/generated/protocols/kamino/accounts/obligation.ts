...
export function getObligationDiscriminatorBytes() {
...
export type Obligation = {
  ...
  depositsAssetTiers: ReadonlyUint8Array;
  /** The asset tier of the borrows */
  borrowsAssetTiers: ReadonlyUint8Array;
...
export function getObligationEncoder(): FixedSizeEncoder<ObligationArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["depositsAssetTiers", fixEncoderSize(getBytesEncoder(), 8)],
      ["borrowsAssetTiers", fixEncoderSize(getBytesEncoder(), 5)],
...
export function getObligationDecoder(): FixedSizeDecoder<Obligation> {
  return getStructDecoder([
    ...
    ["depositsAssetTiers", fixDecoderSize(getBytesDecoder(), 8)],
    ["borrowsAssetTiers", fixDecoderSize(getBytesDecoder(), 5)],
