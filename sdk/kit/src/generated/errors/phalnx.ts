...
export const PHALNX_ERROR__VAULT_NOT_ACTIVE = 0x1770; // 6000
...
export const PHALNX_ERROR__TOO_MANY_POSITIONS = 0x1778; // 6008
/** PositionOpeningDisallowed: Cannot open new positions (policy disallows) */
export const PHALNX_ERROR__POSITION_OPENING_DISALLOWED = 0x1779; // 6009
/** SessionNotAuthorized: Session not authorized */
export const PHALNX_ERROR__SESSION_NOT_AUTHORIZED = 0x177a; // 6010
/** InvalidSession: Invalid session: does not belong to this vault */
export const PHALNX_ERROR__INVALID_SESSION = 0x177b; // 6011
/** OpenPositionsExist: Vault has open positions, cannot close */
export const PHALNX_ERROR__OPEN_POSITIONS_EXIST = 0x177c; // 6012
/** TooManyAllowedProtocols: Policy configuration invalid: too many allowed protocols */
export const PHALNX_ERROR__TOO_MANY_ALLOWED_PROTOCOLS = 0x177d; // 6013
/** AgentAlreadyRegistered: Agent already registered for this vault */
export const PHALNX_ERROR__AGENT_ALREADY_REGISTERED = 0x177e; // 6014
/** NoAgentRegistered: No agent registered for this vault */
export const PHALNX_ERROR__NO_AGENT_REGISTERED = 0x177f; // 6015
/** VaultNotFrozen: Vault is not frozen (expected frozen for reactivation) */
export const PHALNX_ERROR__VAULT_NOT_FROZEN = 0x1780; // 6016
/** VaultAlreadyClosed: Vault is already closed */
export const PHALNX_ERROR__VAULT_ALREADY_CLOSED = 0x1781; // 6017
/** InsufficientBalance: Insufficient vault balance for withdrawal */
export const PHALNX_ERROR__INSUFFICIENT_BALANCE = 0x1782; // 6018
/** DeveloperFeeTooHigh: Developer fee rate exceeds maximum (500 / 1,000,000 = 5 BPS) */
export const PHALNX_ERROR__DEVELOPER_FEE_TOO_HIGH = 0x1783; // 6019
/** InvalidFeeDestination: Fee destination account invalid */
export const PHALNX_ERROR__INVALID_FEE_DESTINATION = 0x1784; // 6020
/** InvalidProtocolTreasury: Protocol treasury account does not match expected address */
export const PHALNX_ERROR__INVALID_PROTOCOL_TREASURY = 0x1785; // 6021
/** InvalidAgentKey: Invalid agent: cannot be the zero address */
export const PHALNX_ERROR__INVALID_AGENT_KEY = 0x1786; // 6022
/** AgentIsOwner: Invalid agent: agent cannot be the vault owner */
export const PHALNX_ERROR__AGENT_IS_OWNER = 0x1787; // 6023
/** Overflow: Arithmetic overflow */
export const PHALNX_ERROR__OVERFLOW = 0x1788; // 6024
/** InvalidTokenAccount: Token account does not belong to vault or has wrong mint */
export const PHALNX_ERROR__INVALID_TOKEN_ACCOUNT = 0x1789; // 6025
/** TimelockNotExpired: Timelock period has not expired yet */
export const PHALNX_ERROR__TIMELOCK_NOT_EXPIRED = 0x178a; // 6026
/** TimelockActive: Vault has timelock active — use queue_policy_update instead */
export const PHALNX_ERROR__TIMELOCK_ACTIVE = 0x178b; // 6027
/** NoTimelockConfigured: No timelock configured on this vault */
export const PHALNX_ERROR__NO_TIMELOCK_CONFIGURED = 0x178c; // 6028
/** DestinationNotAllowed: Destination not in allowed list */
export const PHALNX_ERROR__DESTINATION_NOT_ALLOWED = 0x178d; // 6029
/** TooManyDestinations: Too many destinations (max 10) */
export const PHALNX_ERROR__TOO_MANY_DESTINATIONS = 0x178e; // 6030
/** InvalidProtocolMode: Invalid protocol mode (must be 0, 1, or 2) */
export const PHALNX_ERROR__INVALID_PROTOCOL_MODE = 0x178f; // 6031
/** InvalidNonSpendingAmount: Non-spending action must have amount = 0 */
export const PHALNX_ERROR__INVALID_NON_SPENDING_AMOUNT = 0x1790; // 6032
/** NoPositionsToClose: No open positions to close or cancel */
export const PHALNX_ERROR__NO_POSITIONS_TO_CLOSE = 0x1791; // 6033
/** CpiCallNotAllowed: Instruction must be top-level (CPI calls not allowed) */
export const PHALNX_ERROR__CPI_CALL_NOT_ALLOWED = 0x1792; // 6034
...
export type PhalnxError =
  ...
  | typeof PHALNX_ERROR__AGENT_ALREADY_PAUSED
  | typeof PHALNX_ERROR__AGENT_ALREADY_REGISTERED
  | typeof PHALNX_ERROR__AGENT_IS_OWNER
  | typeof PHALNX_ERROR__AGENT_NOT_PAUSED
  | typeof PHALNX_ERROR__AGENT_PAUSED
  ...
  | typeof PHALNX_ERROR__INVALID_CONSTRAINT_CONFIG
  ...
  | typeof PHALNX_ERROR__INVALID_PROTOCOL_MODE
  | typeof PHALNX_ERROR__INVALID_PROTOCOL_TREASURY
  | typeof PHALNX_ERROR__INVALID_SESSION
  | typeof PHALNX_ERROR__INVALID_SESSION_EXPIRY
  | typeof PHALNX_ERROR__INVALID_TOKEN_ACCOUNT
  | typeof PHALNX_ERROR__LEVERAGE_TOO_HIGH
  | typeof PHALNX_ERROR__MAX_AGENTS_REACHED
  ...
  | typeof PHALNX_ERROR__PROTOCOL_CAPS_MISMATCH
  | typeof PHALNX_ERROR__PROTOCOL_MISMATCH
  ...
  | typeof PHALNX_ERROR__TOO_MANY_POSITIONS
...
let phalnxErrorMessages: Record<PhalnxError, string> | undefined;
if (process.env.NODE_ENV !== "production") {
  phalnxErrorMessages = {
    [PHALNX_ERROR__ACTIVE_ESCROWS_EXIST]: `Cannot close vault with active escrow deposits`,
    [PHALNX_ERROR__AGENT_ALREADY_PAUSED]: `Agent is already paused`,
    [PHALNX_ERROR__AGENT_ALREADY_REGISTERED]: `Agent already registered for this vault`,
    [PHALNX_ERROR__AGENT_IS_OWNER]: `Invalid agent: agent cannot be the vault owner`,
    [PHALNX_ERROR__AGENT_NOT_PAUSED]: `Agent is not paused`,
    [PHALNX_ERROR__AGENT_PAUSED]: `Agent is paused and cannot execute actions`,
    ...
    [PHALNX_ERROR__INVALID_CONSTRAINT_CONFIG]: `Invalid constraint configuration: bounds exceeded`,
    ...
    [PHALNX_ERROR__INVALID_PROTOCOL_MODE]: `Invalid protocol mode (must be 0, 1, or 2)`,
    [PHALNX_ERROR__INVALID_PROTOCOL_TREASURY]: `Protocol treasury account does not match expected address`,
    [PHALNX_ERROR__INVALID_SESSION]: `Invalid session: does not belong to this vault`,
    [PHALNX_ERROR__INVALID_SESSION_EXPIRY]: `Session expiry slots out of range (10-450)`,
    [PHALNX_ERROR__INVALID_TOKEN_ACCOUNT]: `Token account does not belong to vault or has wrong mint`,
    [PHALNX_ERROR__LEVERAGE_TOO_HIGH]: `Leverage exceeds maximum allowed`,
    [PHALNX_ERROR__MAX_AGENTS_REACHED]: `Maximum agents per vault reached (limit: 10)`,
...
export function getPhalnxErrorMessage(code: PhalnxError): string {
  if (process.env.NODE_ENV !== "production") {
    return (phalnxErrorMessages as Record<PhalnxError, string>)[code];
  }

  return "Error message not available in production bundles.";
}

export function isPhalnxError<TProgramErrorCode extends PhalnxError>(
  error: unknown,
  transactionMessage: {
