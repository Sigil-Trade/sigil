...
export function getGetLpTokenPriceInstructionDataEncoder(): FixedSizeEncoder<GetLpTokenPriceInstructionDataArgs> {
...
export function getGetLpTokenPriceInstructionDataDecoder(): FixedSizeDecoder<GetLpTokenPriceInstructionData> {
  return getStructDecoder([
    ["discriminator", fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getGetLpTokenPriceInstructionDataCodec(): FixedSizeCodec<
...
export type GetLpTokenPriceAsyncInput<
...
export async function getGetLpTokenPriceInstructionAsync<
  TAccountPerpetuals extends string,
  TAccountPool extends string,
  TAccountLpTokenMint extends string,
  TAccountIxSysvar extends string,
