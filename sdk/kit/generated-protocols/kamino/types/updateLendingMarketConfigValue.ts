...
export type UpdateLendingMarketConfigValue =
  ...
  | { __kind: "U8Array"; fields: readonly [ReadonlyUint8Array] }
  ...
  | { __kind: "Name"; fields: readonly [ReadonlyUint8Array] };
...
export function getUpdateLendingMarketConfigValueEncoder(): Encoder<UpdateLendingMarketConfigValueArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    [
      "U8Array",
      getStructEncoder([
        ["fields", getTupleEncoder([fixEncoderSize(getBytesEncoder(), 8)])],
      ]),
    ],
...
export function getUpdateLendingMarketConfigValueDecoder(): Decoder<UpdateLendingMarketConfigValue> {
  return getDiscriminatedUnionDecoder([
    ...
    [
      "U8Array",
      getStructDecoder([
        ["fields", getTupleDecoder([fixDecoderSize(getBytesDecoder(), 8)])],
      ]),
    ],
